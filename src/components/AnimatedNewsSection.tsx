      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {news.length > 0 ? (
            ...
            >
              <div className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-2 mb-3">
                  <span className={`px-2.5 py-1 rounded-full text-xs font-medium ${categoryBadgeColors[post.category] || categoryBadgeColors.other}`}>
          ...
          >
            ...
            <p className="text-blue-700 mb-4">We're preparing the latest updates on UK mobile theft trends, arrests, and policy changes.</p>
            <a href="/news" className="text-primary hover:underline font-medium">Check back soon →</a>
          </motion.div>
        )}
      </div>
    </section>

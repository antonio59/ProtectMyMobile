...
export default function VotingSuccess({ stats, formData }: VotingSuccessProps) {
  ...
  return (
    <div className="bg-foreground text-background rounded-lg p-6 md:p-8 border-2 border-border">
      <div className="flex items-start gap-4 mb-6">
        <CheckCircle2 className="size-8 text-foreground flex-shrink-0" />
        <div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <a
          href="#analytics"
          className="px-4 py-2 bg-neutral-100 text-foreground rounded-lg hover:bg-neutral-200 transition-colors"
        >
          View Full Analytics
        </a>
      </div>

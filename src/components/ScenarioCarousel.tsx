    ...
    <div className="space-y-3">
      <div className="relative border border-border rounded-2xl overflow-hidden shadow-sm bg-card">
        ...
        <div className="absolute inset-y-0 left-0 flex items-center">
          <button onClick={() => scrollBy(-1)} aria-label="Previous" className="m-2 rounded-full bg-card/90 border border-border shadow hover:bg-card size-11 flex items-center justify-center text-lg">‹</button>
        </div>
        <div className="absolute inset-y-0 right-0 flex items-center">
          <button onClick={() => scrollBy(1)} aria-label="Next" className="m-2 rounded-full bg-card/90 border border-border shadow hover:bg-card size-11 flex items-center justify-center text-lg">›</button>
        </div>
        ...
        <div className="absolute top-2 right-2">
          <button
            ...
            className="rounded-full bg-card/90 border border-border shadow hover:bg-card size-11 flex items-center justify-center text-muted-foreground hover:text-primary transition-colors"
          ...
          {/* Share dropdown menu */}
          {showShareMenu && (
            <div className="absolute right-0 top-full mt-2 w-48 bg-card rounded-xl  border border-border py-2 z-50 animate-scale-in">

// Shared headline-dedup logic. Canonical home is convex/lib so Convex
// functions can import it without reaching outside the convex/ bundle;
// src/lib/news/dedup.ts re-exports it for the Astro app.
